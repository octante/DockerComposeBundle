...
use Octante\DockerComposeBundle\Model\DockerComposeServiceDefinition;
 ...
 */
class DockerComposeServiceDefinitionBuilder
{
    /**
     * @return DockerComposeServiceDefinitionBuilder
     */
    public function build()
    {
        $dockerComposeServiceDefinition = new DockerComposeServiceDefinition();
        $dockerComposeServiceDefinition
            ...
            ->setLogDriver(new DockerComposeLogDriver())
